...
export const environments = {
    production: true,
    apiBaseUrl: 'https://pos-backend-ricardo.duckdns.org',
    firebase: {
    ...
    firebaseVapidKey: 'BJAcsjp2Tkhjbt4L-u8J_cWzEkn6Q1FU_BvgZYaK4Iaz62ubsvOB16iFF8ljWn2U-aaPuwYM3M25WtqvZCHRpTw'
